...
public class MyPost extends AppCompatActivity {
    ...
    ArrayList<ModelMyPost> list;
    RecyclerMyPostAdapter adapter;
    ModelMyPost modelShowClass;
    FirebaseUser user;
    String uid;
    @Override
        ...
        reference.orderByChild("UserId").equalTo(uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    modelShowClass = dataSnapshot1.getValue(ModelMyPost.class);
                    list.add(modelShowClass);
                }
                adapter = new RecyclerMyPostAdapter(MyPost.this, list);
